...
fn main() {
    ...
    // println!("solution to day 10 part 2: {:?}", day_10::solution_part2(File::open("data/day_10").unwrap()));

    println!("solution to day 11 part 1: {:?}", day_11::solution_part1(File::open("data/day_11").unwrap()));
}
